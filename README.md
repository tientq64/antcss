...
`trtOu` | transition-timing-function: cubic-bezier(.08,.69,.23,.94);
...
`udEl` | -webkit-user-drag: element;<br>user-drag: element;
`udA` | -webkit-user-drag: auto;<br>user-drag: auto;
`udN` | -webkit-user-drag: none;<br>user-drag: none;
